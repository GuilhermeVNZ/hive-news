...
const SCIENTIFIC_SOURCES: &[&str] = &[
    "arxiv", "nature", "science", "ieee", "springer", 
    "elsevier", "acm", "pubmed", "cell", "plos",
    "frontiers", "mdpi", "wiley", "taylor-francis"
];

const SCIENTIFIC_DOMAINS: &[&str] = &[
    "arxiv.org", "nature.com", "science.org", "sciencedirect.com",
    "ieee.org", "springer.com", "acm.org", "nih.gov", "cell.com"
];
...
pub fn detect_source_type(parsed: &ParsedPdf) -> SourceType {
    ...
    let has_references = text_lower.contains("references") 
