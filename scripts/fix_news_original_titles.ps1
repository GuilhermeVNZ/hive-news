...
foreach ($prop in $articles) {
    ...
    # 2. original_title: deve vir do arquivo JSON original na pasta raw (RSS/web scraping)
    ...
    # Se nao encontrou no JSON, manter o original_title atual se for diferente do generated_title
